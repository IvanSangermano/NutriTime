...
export const NavBar = () => {
  ...
  return (
    <>
      <div
        className={
          stateClicked ? styles.spaceContainterActive : styles.spaceContainter
        }
      />
      <div className={stateClicked ? styles.containerActive : styles.container}>
        ...
        <ul className={stateClicked ? styles.navItemsActive : styles.navItems}>
          ...
          {(permissionsConvert?.routinesView ||
          ...
          {(permissionsConvert?.healthsView ||
            permissionsConvert?.healthsAction) && (
        ...
        <div className={stateClicked ? styles.redesActive : styles.redes}>
          <a
            href="https://www.instagram.com/nutritime_app/"
            target="_blank"
          ...
          <a
            href="https://twitter.com/NutriTimeApp"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a
            href="https://www.youtube.com/channel/UCwjpQ2AvhpvZVO2rugFSyQg"
            target="_blank"
            rel="noopener noreferrer"
          >
